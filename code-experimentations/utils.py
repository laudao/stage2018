...
class F_layer:
    ...
    def dominant_sets_attribute(self, labeled_set, a_j):
        '''
            a_ : index of attribute in labeled_set
            labeled_set : labeled set
...
class BinaryTree:
    ...
    def nb_examples_per_path(self):
        ...
        if (self.isLeaf()):
            ...
            l_inf = self.inf.nb_examples_per_path()
            l_sup = self.sup.nb_examples_per_path()
...
class RDMT(Classifier):
    ...
    def avg_nb_examples_per_path(self):
        '''
            return average numbe of examples in a path
        '''
        return np.mean(np.array(self.root.nb_examples_per_path()))
