...
for i in range(10):
    ...
    tree = RDMT(rsdm, "shannon", 0, 100, 0.1 * train_set.size(), [1, 2, 3, 4, 5, 6, 7])
...
f_acc = open("k7acc1_" + sys.argv[2], "wb")
f_leaves = open("k7leaves1_"+ sys.argv[2], "wb")
f_depth = open("k7depth1_"+ sys.argv[2], "wb")
f_ratio = open("k7ratio1_"+ sys.argv[2], "wb")
f_examples = open("k7examples1_"+ sys.argv[2], "wb")
f_pairs = open("k7pairs1_"+ sys.argv[2], "wb")
f_eval = open("k7eval1_" + sys.argv[2], "wb")
