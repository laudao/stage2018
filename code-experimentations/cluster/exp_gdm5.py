...
for i in range(10):
    ...
    tree = RDMT(gdm, "shannon", 0, 100, 0.01, [1, 2, 3, 4, 5])
...
f_acc = open("acc5_4_" + sys.argv[2], "wb")
f_leaves = open("leaves5_4_"+ sys.argv[2], "wb")
f_depth = open("depth5_4_"+ sys.argv[2], "wb")
f_ratio = open("ratio5_4_"+ sys.argv[2], "wb")
f_pairs = open("pairs5_4_"+ sys.argv[2], "wb")
f_eval = open("eval5_4_"+ sys.argv[2], "wb")
f_pratio = open("p_ratio5_4_"+sys.argv[2], "wb")
f_nb_examples = open("nb_examples5_4_" + sys.argv[2], "wb")
