...
for i in range(10):
    ...
    tree = RDMT(rgdm, "shannon", 0, 100, 0.01, [1, 2, 3])
...
f_acc = open("acc3_3_" + sys.argv[2], "wb")
f_leaves = open("leaves3_3_"+ sys.argv[2], "wb")
f_depth = open("depth3_3_"+ sys.argv[2], "wb")
f_ratio = open("ratio3_3_"+ sys.argv[2], "wb")
f_pairs = open("pairs3_3_"+ sys.argv[2], "wb")
f_eval = open("eval3_3_"+ sys.argv[2], "wb")
f_pratio = open("p_ratio3_3_"+sys.argv[2], "wb")
