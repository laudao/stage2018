...
for i in range(10):
    ...
    tree = RDMT(sdm, "shannon", 0, 100, 0.1 * train_set.size(), [1, 2])
...
f_acc = open("k2acc2_" + sys.argv[2], "wb")
f_leaves = open("k2leaves2_"+ sys.argv[2], "wb")
f_depth = open("k2depth2_"+ sys.argv[2], "wb")
f_ratio = open("k2ratio2_"+ sys.argv[2], "wb")
f_examples = open("k2examples2_"+ sys.argv[2], "wb")
f_pairs = open("k2pairs2_"+ sys.argv[2], "wb")
f_eval = open("k2eval2_" + sys.argv[2], "wb")
