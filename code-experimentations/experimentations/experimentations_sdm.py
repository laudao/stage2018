...
f_acc = open("acc2_" + sys.argv[2], "wb")
f_leaves = open("leaves2_"+ sys.argv[2], "wb")
f_depth = open("depth2_"+ sys.argv[2], "wb")
f_ratio = open("ratio2_"+ sys.argv[2], "wb")
f_pairs = open("pairs2_"+ sys.argv[2], "wb")
