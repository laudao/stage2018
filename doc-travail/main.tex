...
\State $\Gamma_{\leq}\gets$ BUILD\_DT($\Omega_{\leq}, H^*, H, \epsilon, \Delta,
    n_{min}, \lambda, \delta +1$) 
\State $\Gamma_{\geq}\gets$
    BUILD\_DT($\Omega_{\geq}, H^*, H, \epsilon, \Delta, n_{min}, \lambda, \delta
    +1$)
\State $\Gamma\gets \{a^{x_*}_*\} \cup \Gamma_{\leq} \cup \Gamma{\geq}$ 
