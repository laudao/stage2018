...
Etant donnés $\Omega = \{\omega_i, ... , \omega_n\}, \mathcal{A} = \{a_1, ...,
...
h \in \{1, ..., n\}, A[i][h] = 1$ si et seulement si $a_j(\omega_i) \leq
a_j(\omega_h)$ et $D[i][h] = 1$ si et seulement si $\lambda(\omega_i)
\leq \lambda(\omega_h)$. En ce qui concerne les classes d'équivalence, $A[i][h]
