...
Dans cette partie, on présente les méthodes proposées par Hu et al.
...
% définir ces mesures plus haut
Les arbres sont évalués sur leur accuracy, leur profondeur, leur nombre de
feuilles, leur ratio de paires de feuilles non-monotones, ainsi que le nombre de
paires de feuilles. 
